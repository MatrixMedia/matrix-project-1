...
routes.get('/generate-excel', async (req, res) => {
    try {
        const communityId = req.query.communityId
        const buffer = await Services.EventService.generateExcel(communityId);
...
routes.get('/generate-excel-member', async (req, res) => {
    try {
        const communityId = req.query.communityId;
        const buffer = await Services.OrganizationService.generateExcelMemberList(communityId);
...
routes.get('/generate-excel-familymember', async (req, res) => {
    try {
        const communityId = req.query.communityId;
        const buffer = await Services.OrganizationService.generateExcelFamilyMemberwiseList(communityId);
...
routes.get('/generate-excel-group', async (req, res) => {
    try {
        const communityId = req.query.communityId;
        const buffer = await Services.OrganizationService.generateExcelGroupwiseList(communityId);
...
routes.get('/generate-excel-payment', async (req, res) => {
    try {
        const eventId = req.query.eventId;
        const buffer = await Services.EventPaymentService.generateExcelPaymentList(eventId);
...
routes.get('/generate-excel-task', async (req, res) => {
    try {
        const eventId = req.query.eventId;
        const buffer = await Services.EventTaskService.generateExcelTaskList(eventId);
...
routes.get('/generate-excel-supplier', async (req, res) => {
    try {
        const eventId = req.query.eventId;
        const buffer = await Services.EventSupplierManagementService.generateExcelSupplierList(eventId);
...
routes.get('/generate-excel-supplier-log', async (req, res) => {
    try {
        const supplierId = req.query.supplierId;
        const buffer = await Services.EventSupplierManagementService.generateExcelSupplierLogList(supplierId);

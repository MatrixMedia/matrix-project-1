...
module.exports = {
    ...
    Mutation: {
        ...
        async updateHomePageOverview(root, args, context, info) {
            ...
            const id = args.data.id;
            let result = await Services.CommunityWebpageService.updateHomePageOverview(id, data);
            if (result.error) {
        ...
        async updateCommunityFeaturedStatus(root, args, context, info) {
            const data = args.data;
            const id = args.data.id;
            let result = await Services.CommunityWebpageService.updateCommunityFeaturedStatus(id);
            if (result.error) {
                throw new ErrorModules.GeneralApiError(Lib.translate(result.message));
            } else {
                return Lib.sendResponse(result);
        ...
        async updatefreezePaneStatus(root, args, context, info) {
            const data = args.data;
            const id = args.data.id;
            let result = await Services.CommunityWebpageService.updatefreezePaneStatus(id);
            if (result.error) {
                throw new ErrorModules.GeneralApiError(Lib.translate(result.message));
            } else {
                return Lib.sendResponse(result);
        ...
        async updateEventPaymentStatus(root, args, context, info) {
            const data = args.data;
            const id = args.data.id;
            let result = await Services.CommunityWebpageService.updateEventPaymentStatus(id);
            if (result.error) {
                throw new ErrorModules.GeneralApiError(Lib.translate(result.message));
            } else {
                return Lib.sendResponse(result);
        ...
        async updateCommunityAnnouncementSettings(root, args, context, info) {
            const data = args.data;
            const id = args.data.id;
            let result = await Services.CommunityWebpageService.updateCommunityAnnouncementSettings(id, data);
            if (result.error) {
                throw new ErrorModules.GeneralApiError(Lib.translate(result.message));
            } else {
                return Lib.sendResponse(result);
        ...
        async updateCommunityAboutUsSettings(root, args, context, info) {
            const data = args.data;
            const id = args.data.id;
            let result = await Services.CommunityWebpageService.updateCommunityAboutUsSettings(id, data);
            if (result.error) {
                throw new ErrorModules.GeneralApiError(Lib.translate(result.message));
            } else {
                return Lib.sendResponse(result);

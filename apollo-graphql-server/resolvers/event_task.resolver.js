...
module.exports = {
  ...
  Mutation: {
    ...
    async deleteEventTask(root, args, context, info) {
      ...
      let result = await Services.EventTaskService.deleteEventTask(id);
      return Lib.sendResponse(result);
    },
    async eventTaskStatusChange(root, args, context, info) {
      const result = await Services.EventTaskService.eventTaskStatusChange(args.id);
      return Lib.sendResponse(result);
    },
    async assignMembers(root, args, context, info) {
      ...
      const result = await Services.EventTaskService.assignMember(args.data);
    ...
    async deleteAssignMember(root, args, context, info) {
      let result = await Services.EventTaskService.deleteAssignMember(args.data);
      return Lib.sendResponse(result);
    },

...
module.exports = {
  Query: {
    ...
    async communityActivePassiveMemberDetails(root, args, context, info) {
      ...
      const user = await Services.OrganizationService.ActivePassiveMemberDetailsByID(userId, communityId, context, page);
  ...
  Mutation: {
    ...
    async addOrgGlobalSettings(root, args, context, info) {
      ...
      const result = await Services.OrganizationService.addOrgGlobalSettings(communityId, args.data);
      const userCommunityPortal =
        await Services.UserService.getUserCommunityPortalDetails(
          context.getAuthUserInfo(),
          communityId
    ...
    async updateSmsEmailGlobalSettings(root, args, context, info) {
      const data = args.data;
      const result = await Services.OrganizationService.updateSmsEmailGlobalSettings(data);
      return Lib.sendResponse(result);
    },
  },
};

...
module.exports = {
  ...
  Mutation: {
    async createEventSupplierManagement(root, args, context, info) {
      ...
      const result = await Services.EventSupplierManagementService.createEventSupplierManagement(userName, args.data);
    ...
    async deleteEventSupplierManagement(root, args, context, info) {
      let result = await Services.EventSupplierManagementService.deleteEventSupplierManagement(args.data);
      return Lib.sendResponse(result);
    },
    async assignSupplierMembers(root, args, context, info) {
      ...
      //     communityId
      //   );
      const result = await Services.EventSupplierManagementService.assignSupplierMembers(args.data);
      // if (result && !result.error) {
      //   const payload = {
      //     recipient:
      //     {
    ...
    async deleteAssignSupplierMembers(root, args, context, info) {
      let result = await Services.EventSupplierManagementService.deleteAssignSupplierMembers(args.data);
      return Lib.sendResponse(result);
    },
    ...
    async adminQuantityStatusChange(root, args, context, info) {
      const data = args.data;
      const result = await Services.EventSupplierManagementService.adminQuantityStatusChange(data);
      return Lib.sendResponse(result);
    }
  }
}
...
module.exports = {
  ...
  ActivePassiveMemberDetailsByID: async function (
    ...
    try {
      ...
      console.log(familyMembersObj,"familyMembersObj.............");
  ...
  switchOrganiztionPortal: async function (data, context) {
    ...
    if (communities.members.roles[0] === "board_member") {
      ...
      payload = {
        ...
        image: "https://developmentmatrix.s3.ap-south-1.amazonaws.com/image_2024_03_19T13_57_20_167Z.png"
      }
      await notificationServices.notifyService(payload);
    }
  ...
  addOrgGlobalSettings: async function (communityId, params) {
  ...
  generateExcelMemberList: async function (communityId) {
    try {
      let aggregate = [
        {
          $match: {
  ...
  generateExcelFamilyMemberwiseList: async function (communityId) {
    try {
      let aggregate = [
        {
          $match: {
  ...
  generateExcelGroupwiseList: async function (communityId) {
    try {
      let aggregate = [
        {
          $match: {
  ...
  getGroupNamesByMemberIds: async function (memberIds, communityId) {
    ...
    console.log(groupNamesMap,'groupNamesMap');
  ...
  updateSmsEmailGlobalSettings: async function (data) {
    try {

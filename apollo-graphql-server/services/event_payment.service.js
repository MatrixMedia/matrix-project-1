...
module.exports = {
    ...
    // },
    //Mutation
    deleteEventPayment: async function (id) {
        try {
        ...
        try {
            ...
            if (rsvpStatus === 'paid') {
                payload = {
                    ...
                    image: "https://developmentmatrix.s3.ap-south-1.amazonaws.com/image_2024_03_18T07_41_34_650Z.png"
                }
                ...
                payload = {
                    ...
                    image: "https://developmentmatrix.s3.ap-south-1.amazonaws.com/image_2024_03_18T07_41_34_647Z.png"
                }
                await notificationServices.notifyService(payload);
    ...
    generateExcelPaymentList: async function (eventId) {
        try {
            const pipeline = [
                {
                    '$match': {

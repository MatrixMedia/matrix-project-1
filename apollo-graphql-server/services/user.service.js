...
module.exports = {
    ...
    getUsers: async function (params) {
        try {
            ...
            const aggregationPipeline = [
                ...
                // {
                //     $match:{
                //         'user_master.communityMemberId':"QCS20240049"
                //     }
                // },
                {
                    $project: {
            ...
            const user = await Communities.aggregate(aggregationPipeline);
            const total = await User.find(condition).count();
    ...
    // getLoggedInUsers: async function (params) {
    //     try {
    ...
    //         // Calculate the actual 'from' and 'to' values for the response
    //         const from = skip + 1;
    ...
    updateProfileData: async function (logUser, args, admin) {
        ...
        // console.log(familyMemberUser,"familyMemberUser.............")
        if (familyMemberUser) {
            let updated = false;

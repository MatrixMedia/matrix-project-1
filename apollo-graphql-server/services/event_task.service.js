...
module.exports = {
    ...
    eventTaskStatusChange: async function (eventTaskId) {
        const eventTask = await EventTask.findOne({
    ...
    deleteEventTask: async function (id) {
        try {
            const EventTaskObj = {
                "is_deleted": true
            }
    ...
    assignMember: async function (data) {
    ...
    deleteAssignMember: async function (data) {
    ...
    generateExcelTaskList: async function (eventId) {
        try {
            const pipeline = [
                {
                    '$match': {

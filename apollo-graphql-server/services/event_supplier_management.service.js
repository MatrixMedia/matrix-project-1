...
module.exports = {
    ...
    //Mutation
    createEventSupplierManagement: async (userName, data) => {
    ...
    deleteEventSupplierManagement: async function (data) {
        try {
    ...
    assignSupplierMembers: async function (data) {
    ...
    generateExcelSupplierList: async function (eventId) {
        try {
            const pipeline = [
                {
                    '$match': {
    ...
    generateExcelSupplierLogList: async function (supplierId) {
        try {
            const pipeline = [
                {
                    '$match': {
    ...
    adminQuantityStatusChange: async function (data) {
        try {
